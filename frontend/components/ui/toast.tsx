...
const toastVariants = cva(
  ...
  { variants: { variant: { default: "glass border-border bg-background text-foreground", success: "border-success/50 bg-success/10 text-success", destructive: "border-destructive/50 bg-destructive/10 text-destructive", warning: "border-warning/50 bg-warning/10 text-warning" } }, defaultVariants: { variant: "default" } }
);
